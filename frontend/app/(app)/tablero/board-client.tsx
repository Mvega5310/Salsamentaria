...
export default function BoardClient({ orders, tenantId }: { orders: BoardOrder[]; tenantId: string }) {
  ...
  return (
    <div className="p-6">
      {tenantId ? <OrderAlert tenantId={tenantId} /> : null}
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-wrap gap-1.5">
                  ...
                  {o.payment_method === "wompi_online" ? (
                    o.payment_status === "pagado" ? (
                      <span className="rounded-full bg-[#DFEAE2] px-2.5 py-1.5 text-[11px] font-bold text-[#2E5340]">
                        Pagado en línea
                      </span>
                    ) : (
                      <span className="rounded-full bg-[#F6DED6] px-2.5 py-1.5 text-[11px] font-bold text-[#8A2B14]">
                        Pago pendiente
                      </span>
                    )
                  ) : null}
