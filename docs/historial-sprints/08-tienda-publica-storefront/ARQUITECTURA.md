...
**Pendiente:**
- [ ] Manifest.json dinámico por tenant + service worker para instalación real como PWA (hoy es una web responsiva, no instalable)
...
**Siguiente**
- [ ] Manifest/service worker para instalación real como PWA
