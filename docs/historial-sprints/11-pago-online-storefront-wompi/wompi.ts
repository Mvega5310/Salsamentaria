...
// ---------------------------------------------------------------------------
// Parámetros para el Checkout Web hospedado (formulario + redirección) —
// usado por el checkout de la tienda pública. El cliente nunca ve tarjetas;
// Wompi las recibe en su propia página. La firma se calcula aquí, en el
// servidor, porque si se calculara en el navegador cualquiera podría
// alterar el monto antes de enviarlo.
// ---------------------------------------------------------------------------
export function buildHostedCheckoutParams(params: {
  reference: string;
